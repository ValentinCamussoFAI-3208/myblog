...
<x-app-layout>
    ...
    <div class="bg-gray-600 flex items-center justify-center flex-col text-gray-800 dark:text-gray-200">
        <div class="flex flex-col items-center px-4 w-4/6">
            @if ($posts->isEmpty())
            <p class="mt-48">No hay posts en esta categoría.</p>

            <a href="/category/{{ $category->id}}/create" class="mt-12 mb-48 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Crear post
            </a>
            ...
            <div class="bg-slate-800 flex flex-col-reverse">
                ...
                <div class="w-auto mx-auto mt-6">
                    @if (!$posts->isEmpty())
                    <a href="/category/{{ $category->id}}/create" class="my-5 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Crear post
                    </a>
                    @endif
                </div>
                ...
                <div class="w-auto mx-auto mt-6">
                    @if (!$posts->isEmpty())
                    <a href="/login" class="my-5 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Crear post
                    </a>
                    @endif
                </div>
