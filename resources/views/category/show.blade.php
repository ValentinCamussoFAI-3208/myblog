...
<x-app-layout>
    ...
    <div class="bg-gray-600 flex items-center justify-center flex-col text-gray-800 dark:text-gray-200">
        <div class="bg-slate-800 flex flex-col items-center p-4 w-1/2">
            <div class="rounded mx-auto">
                <div class="mx-auto px-4 py-8 my-20 w-3/5">
                    <div class="bg-white shadow-2xl rounded-lg mb-6 tracking-wide">
                        ...
                        <div class="md:flex-shrink-0">
                            <img src="{{ asset('storage/' . $post->poster) }}" alt="Poster {{ $post->title }}" class="w-full h-96 object-cover rounded rounded-t-none">
                        </div>
                    </div>
                </div>
